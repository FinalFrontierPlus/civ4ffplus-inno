;Final Frontier Plus - Full Download Script
;Builds an installer with everything necessary to run the mod

#define FullSource "C:\Program Files (x86)\Firaxis Games\Sid Meier's Civilization 4\Beyond the Sword\Mods\Final Frontier Plus"
...
OutputBaseFilename=Final_Frontier_Plus_{#Version}_Full_Download
Compression=lzma
...
[Files]
Source: "{#FullSource}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: FinalFrontierPlus
